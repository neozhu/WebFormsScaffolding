<%@ Page Title="MovieEdit" Language="VB" MasterPageFile="~/Site.Master" CodeBehind="Edit.aspx.vb" Inherits="Samples.Edit" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
		<p>&nbsp;</p>
        <asp:FormView runat="server"
            ItemType="Samples.Movie" DefaultMode="Edit" DataKeyNames="Id"
