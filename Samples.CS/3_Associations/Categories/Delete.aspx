<%@ Page Title="CategoryDelete" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Delete.aspx.cs" Inherits="Samples._3_Associations.Categories.Delete" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
		<p>&nbsp;</p>
        <h3>Are you sure want to delete this Category?</h3>
        <asp:FormView runat="server"
            ItemType="Samples.Associations.Category" DataKeyNames="Id"
